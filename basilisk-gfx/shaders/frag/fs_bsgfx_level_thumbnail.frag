...
layout(set = BSGFX_SET_IMAGE_LEVEL_THUMBNAIL, binding = BSGFX_BINDING_IMAGE_LEVEL_THUMBNAIL) uniform sampler2DArray thumbnails;
...
void main() {
    ...
    out_color = texture(thumbnails, vec3(in_texture.x, 1.0 - in_texture.y, in_position.z)) * in_color;
    out_normal.xyz = in_normal;
