...
#include "project/basilisk-gfx/shaders/bsgfx_point.glsl"
...
void main() {
    ...
    out_color = bsgfx_point_instances[int(gl_InstanceIndex)].color;
    out_world_position = bsgfx_translatePoint(int(gl_InstanceIndex)).xyz;
    gl_PointSize = bsgfx_pointSize(int(gl_InstanceIndex));
